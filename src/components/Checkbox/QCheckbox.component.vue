...
<template>
    <label for="" class="q-checkbox" :class="classes" @click="() => handleClick()" @input="() => handleInput()"
        @blur="() => handleBlur()" @focus="() => handleFocus()">
        <input type="checkbox" class="q-checkbox__input" v-model="modelValue" :title="title" :name="name"
            :indeterminate="indeterminate" :checked="checked" :disabled="disabled" :required="required">
